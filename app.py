...
st.set_page_config(page_title="PREDECTIVE ANALYSIS FOR ACCIDENT PREVENTION AND RESPONSE",
...
st.markdown("🚧PREDECTIVE ANALYSIS FOR ACCIDENT PREVENTION AND RESPONSE 🚧", unsafe_allow_html=True)
...
st.text("""   Here we create a web application that takes input from the user and predicts the severity of the accident based on the model that is been deployed.The
user needs to fill all the required details of the accident in order to predict the severity.""")
